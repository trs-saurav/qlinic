...
import { Users, Stethoscope, Building2, Heart, Sparkles, ArrowLeft, Check } from 'lucide-react'
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            >
              <div className="sticky top-8">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Choose Your Role</h3>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-start gap-4">
                          <div
                            className={`w-14 h-14 rounded-xl flex items-center justify-center bg-gradient-to-br ${role.gradient} shadow-lg flex-shrink-0`}
                          >
                            <IconComponent className="w-7 h-7 text-white" />
                          </div>

                          <div className="flex-1">
                            <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-1">{role.label}</h4>
                ...
                >
                  <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">You're signing up as:</p>
                  <div className="flex items-center gap-2">
                    {selectedRoleObj?.icon
                      ? React.createElement(selectedRoleObj.icon, {
                          className: 'w-5 h-5 text-blue-600 dark:text-blue-400',
                        })
                      : null}
                    <span className="font-bold text-gray-900 dark:text-white">{selectedRoleObj?.label}</span>
                  </div>
                </motion.div>
              </div>
            </motion.div>
            ...
            >
              ...
              />
              {/* Clerk copies SignUp.unsafeMetadata to User.unsafeMetadata after sign-up [web:498][page:1] */}
            </motion.div>
          </div>
